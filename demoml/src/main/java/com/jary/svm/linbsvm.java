...
public class linbsvm {
    ...
    public static void main(String[] args) {
        linbsvm t123 = new linbsvm();

        svm_model model2 = t123.svmTrain("data/mllib/sonar_scale_train.txt", 208, 60);

        t123.evaluate_all_instances("data/mllib/sonar_test.txt", model2, 10);
