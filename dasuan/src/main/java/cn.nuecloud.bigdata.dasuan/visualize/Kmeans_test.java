...
import cn.nuecloud.bigdata.dasuan.analysis.clustering.DSKMeans;
 ...
 */
public class Kmeans_test implements java.io.Serializable{
        ...
        try {
            ...
            JavaRDD<String> data = myRDD.flatMap(new FlatMapFunction<Tuple2<ImmutableBytesWritable, Result>, String>() {
                ...
                public Iterable<String> call(Tuple2<ImmutableBytesWritable, Result> t) throws Exception {
                    ...
                    return Arrays.asList(Move_Speed + "," + Rotate_Speed);
                }
            });
            ...
            personDF.show();
            DSKMeans kms = new DSKMeans(personDF,sc);
          KMeansModel modle = kms.clusters(3,20);
          DataFrame reJavaRDD=kms.getAnalyizedData(modle);
            reJavaRDD.show();
...
//            st.executeUpdate(sql);
    ...
    public static void main(String args[]) {
        Kmeans_test ttHbase = new Kmeans_test();
        ttHbase.testFrame();
    }
}
