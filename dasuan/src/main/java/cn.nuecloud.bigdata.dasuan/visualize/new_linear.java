...
import cn.nuecloud.bigdata.dasuan.analysis.regression.LinearRegression_ml;
 ...
 */
public class new_linear implements java.io.Serializable{
        ...
        try {
            ...
            JavaRDD<String> data = myRDD.flatMap(new FlatMapFunction<Tuple2<ImmutableBytesWritable, Result>, String>() {
                ...
                public Iterable<String> call(Tuple2<ImmutableBytesWritable, Result> t) throws Exception {
                    ...
                    String COLLECTDATA = Bytes.toString(t._2.getValue(Bytes.toBytes("cf1"), Bytes.toBytes("Move_Speed")));
                    String COLLECTTIME = Bytes
                            .toString(t._2.getValue(Bytes.toBytes("cf1"), Bytes.toBytes("Pure_Movement")));
                    return Arrays.asList(COLLECTDATA + "," + COLLECTTIME);
                }
            });
...
//            bb.setElasticNetParam(2);
//            bb.setMaxIter(10);
            bb.setRegParam(0.3);
            bb.setStandardization(true);
            LinearRegression_ml lr = new LinearRegression_ml();
            LinearRegressionModel aa=lr.LinearRegression_ml(personDF,bb,sc);
            personDF.show();
            System.out.println("Coefficients: "
                    + aa.coefficients() + " Intercept: " + aa.intercept());
            double[] d = new double[]{4.0,6.0,7.2};
...
//            st.executeUpdate(sql);
    ...
    public static void main(String args[]) {
        new_linear ttHbase = new new_linear();
        ttHbase.testFrame();
    }
}
